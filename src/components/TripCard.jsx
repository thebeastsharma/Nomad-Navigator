...
const TripCard = ({ trip, onSelectTrip, handleDeleteTrip }) => {
    ...
    return (
      <div className="bg-white dark:bg-blue-900 rounded-xl shadow-lg transition duration-300 hover:shadow-xl transform border-l-4 border-orange-500 overflow-hidden flex flex-col">
        <div 
            className="flex flex-row cursor-pointer"
            onClick={() => onSelectTrip(trip.id)}
        >
            <div className={`flex-shrink-0 w-full md:w-32 h-32 bg-orange-50 dark:bg-orange-950/50`}>
